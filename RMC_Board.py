...
# 페이지 로고 ㅍ
st.image("./static/logo/RimcMonlogo.png", use_column_width=True )
...
# 사이드 바 입니다.
st.sidebar.title("❄️ 사이드 바 입니다. 📄")
st.sidebar.caption("내용 [Naver](https://www.naver.com/)")

st.sidebar.caption("내용 [Youtube](https://www.youtube.com).")

with st.sidebar.expander("기능"):
...
with st.sidebar.expander("기능"):
    st.markdown(""" 내용 [here](https://docs.snowflake.com/en/release-notes/new-features).""")
cols = st.columns(2)

# sql 쪽 부분 인같아 해석 부분 X
